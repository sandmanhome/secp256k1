...
func initP256Sm2() {
	...
	sm2P256.BitSize = 256
	sm2P256.byteSize = sm2P256.BitSize / 8
	sm2P256.H = 1
	sm2P256.halfOrder = new(big.Int).Rsh(sm2P256.N, 1)
	sm2P256.q = new(big.Int).Div(new(big.Int).Add(sm2P256.P,
...
func P256Sm2() *Sm2P256Curve {
	initonce.Do(initAll)
	return &sm2P256
}

func (curve Sm2P256Curve) QPlus1Div4() *big.Int {
	return curve.q
}
